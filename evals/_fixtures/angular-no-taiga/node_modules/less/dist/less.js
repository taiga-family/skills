...
(function (global, factory) {
    ...
    const VARIABLE_INTERPOLATION = new RegExp(`@\\{(${VARIABLE_WITH_LOOKUPS})\\}`, 'g');
     ...
     */
    const PROPERTY_INTERPOLATION = /\$\{([\w-]+)\}/g;
     ...
     * @returns {Node}
     */
    function resolveInterpolatedVariable(raw, index, fileInfo) {
     ...
     * @returns {Node}
     */
    function resolveInterpolatedProperty(raw, index, fileInfo) {
